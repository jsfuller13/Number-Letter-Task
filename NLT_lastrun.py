...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\jsful\\Downloads\\Experiment Building-20201004T190124Z-001\\Experiment Building\\1. Number_Letter Task\\NLT_lastrun.py',
...
win = visual.Window(
    ...
    monitor='Dell', color=[0,0,0], colorSpace='hsv',
